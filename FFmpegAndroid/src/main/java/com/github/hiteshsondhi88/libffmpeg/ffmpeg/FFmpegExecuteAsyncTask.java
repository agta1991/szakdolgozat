...
public class FFmpegExecuteAsyncTask extends AsyncTask<Void, String, CommandResult> {
    ...
    private final ExecuteResponseHandler ffmpegExecuteResponseHandler;
    ...
    FFmpegExecuteAsyncTask(String[] cmd, long timeout, ExecuteResponseHandler ffmpegExecuteResponseHandler) {
        this.cmd = cmd;
